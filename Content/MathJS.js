...
{
 "use strict";
 var Global,WebSharper,MathJS,Samples,Main,Operators,Obj,UI,Doc,Array,Var$1,View,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,Handler,MathJS_Templates,Var,EventTarget,Client,Templates,JavaScript,Pervasives,List,T,Unchecked,Object,DomUtility,ConcreteVar,Snap,Collections,List$1,System,Guid,Dictionary,HashSet,Client$1,Seq,AttrModule,Node,JS,DocElemNode,CharacterData,Enumerator,AttrProxy,Abbrev,Fresh,DictionaryUtil,T$1,CheckedInput,Numeric,Attrs,Docs,SC$1,WindowOrWorkerGlobalScope,SC$2,Attrs$1,Dyn,Elt,DynamicAttrNode,Prepare,Slice,KeyCollection,An,Settings,Mailbox,Updates,SC$3,Strings,Docs$1,RunState,NodeSet,Anims,SC$4,HashSetUtil,SC$5,Queue,SC$6,Concurrency,AppendList,String,Easing,AsyncBody,SC$7,CT,HashSet$1,Char,Scheduler,CancellationTokenSource,DomNodes,Error,OperationCanceledException,Lazy,SC$8,LazyExtensionsProxy,LazyRecord,math,MathJax,Hub,IntelliFactory,Runtime$1,console,$,Math,Date;
 Global=self;
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 MathJS=WebSharper.MathJS=WebSharper.MathJS||{};
 Samples=MathJS.Samples=MathJS.Samples||{};
 ...
 MathJS_Templates=Global.MathJS_Templates=Global.MathJS_Templates||{};
 Var=UI.Var=UI.Var||{};
 ...
 {
  var a;
  a=Doc.Concat([Doc.Element("h3",[],[Doc.TextNode("Big numbers")]),Main.BigNumbers(),Doc.Element("h3",[],[Doc.TextNode("Differentiation")]),Main.Differentiation(),Doc.Element("h3",[],[Doc.TextNode("Vector operations")]),Main.Vectors(),Doc.Element("h3",[],[Doc.TextNode("Matrix operations")]),Main.Matrices(),Doc.Element("h3",[],[Doc.TextNode("Units")]),Main.Units()]);
  Templates.LoadLocalTemplates("");
  Doc.RunById("main",a);
 };
 Main.BigNumbers=function()
 {
  var rvInput1,rvInput2,viewInput1,viewInput2,resultAdd,resultSubtract,resultMultiply,resultDivide,b,p,i;
  function result(operator)
  {
   return View.Map2(function(l,r)
   {
    var c;
    try
    {
     c=(operator(math.bignumber(l)))(math.bignumber(r));
  ...
  rvInput1=Var$1.Create$1("1");
  rvInput2=Var$1.Create$1("1");
  viewInput1=rvInput1.get_View();
  viewInput2=rvInput2.get_View();
  resultAdd=result(function(l)
  {
   return function(r)
   {
    return math.add(l,r);
  ...
  resultSubtract=result(function(l)
  {
   return function(r)
   {
  ...
  resultMultiply=result(function(l)
  {
   return function(r)
   {
  ...
  resultDivide=result(function(l)
  {
   return function(r)
   {
  ...
  return(b=ProviderBuilder.Make().WithHole({
   ...
   $0:"resultdivide",
   $1:resultDivide
  }),(p=Handler.CompleteHoles(b.k,b.h,[["input1",0],["input2",0]]),(i=new TemplateInstance.New(p[1],MathJS_Templates.bignumbers(p[0])),(b.i=i,i)))).get_Doc();
 };
 Main.Differentiation=function()
 {
  var r,r$1,rvFormula,rvDerivateBy,texFormula,tex,b,p,i;
  function a(e,v)
  {
   e.textContent="$$"+v+"$$";
   Hub.Queue([["Typeset",Hub,[e]]]);
  }
  Hub.Config((r={},r.extensions=["tex2jax.js"],r.jax=["input/TeX","output/HTML-CSS"],r.tex2jax=(r$1={},r$1.inlineMath=[["$","$"],["\\(","\\)"]],r$1),r));
  rvFormula=Var$1.Create$1("x^2/(x^9 + x^2) + x^4/2");
  rvDerivateBy=Var$1.Create$1("x");
  texFormula=View.Map2(function(formula,derivateby)
  {
   var r$2;
   try
   {
    return math.derivative(formula,derivateby,(r$2={},r$2.simplify=true,r$2)).toTex();
   }
   catch(m)
   {
    return"The\\ formula\\ isn't\\ correct.";
   }
  },rvFormula.get_View(),rvDerivateBy.get_View());
  tex=Doc.Element("div",[AttrModule.DynamicCustom(function($1)
  {
   return function($2)
   {
    return a($1,$2);
   };
  },texFormula)],[Doc.TextView(View.Map(function($1)
  {
   return"$$"+$1+"$$";
  },texFormula))]);
  return(b=ProviderBuilder.Make().WithHole({
   ...
   $0:"tex",
   $1:tex
  }),(p=Handler.CompleteHoles(b.k,b.h,[["formula",0],["derivateby",0]]),(i=new TemplateInstance.New(p[1],MathJS_Templates.differentiation(p[0])),(b.i=i,i)))).get_Doc();
 };
 Main.Vectors=function()
 {
  var r,r$1,vector1,vector2,prettyVector1,prettyVector2,resultAdd,resultSubtract,resultMultiply,prettyResultAdd,prettyResultSubtract,prettyResultMultiply,b,p,i;
  function result(op)
  {
   return"["+Global.String((op(vector1))(vector2))+"]";
  }
  Hub.Config((r={},r.extensions=["tex2jax.js"],r.jax=["input/TeX","output/HTML-CSS"],r.tex2jax=(r$1={},r$1.inlineMath=[["$","$"],["\\(","\\)"]],r$1),r));
  vector1=[8,6,4,6];
  vector2=[6,14,8,2];
  prettyVector1="$"+math.parse("["+Global.String(vector1)+"]").toTex()+"$";
  prettyVector2="$"+math.parse("["+Global.String(vector2)+"]").toTex()+"$";
  resultAdd=result(function(l)
  {
   return function(r$2)
   {
    return math.add(l,r$2);
   };
  });
  resultSubtract=result(function(l)
  {
  ...
  resultMultiply=result(function(l)
  {
   return function(r$2)
   {
    return math.multiply(l,r$2);
   };
  });
  prettyResultAdd="$"+math.parse(Global.String(resultAdd)).toTex()+"$";
  prettyResultSubtract="$"+math.parse(Global.String(resultSubtract)).toTex()+"$";
  prettyResultMultiply="$"+math.parse(Global.String(resultMultiply)).toTex()+"$";
  return(b=ProviderBuilder.Make().WithHole({
   $:1,
   $0:"vector1",
   $1:prettyVector1
   ...
   $:1,
   $0:"resultsubtract",
   $1:prettyResultSubtract
  }).WithHole({
   $:1,
   $0:"resultmultiply",
   $1:prettyResultMultiply
  }),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],MathJS_Templates.vectors(p[0])),(b.i=i,i)))).get_Doc();
 };
 Main.Matrices=function()
 {
  var r,r$1,matrix1,matrix2,prettyMatrix1,prettyMatrix2,resultAdd,resultSubtract,resultMultiply,resultDivide,prettyResultAdd,prettyResultSubtract,prettyResultMultiply,prettyResultDivide,b,p,i;
  function result(op)
  {
   return(op(matrix1))(matrix2);
  }
  Hub.Config((r={},r.extensions=["tex2jax.js"],r.jax=["input/TeX","output/HTML-CSS"],r.tex2jax=(r$1={},r$1.inlineMath=[["$","$"],["\\(","\\)"]],r$1),r));
  matrix1=math.matrix([[8,6],[4,6]]);
  matrix2=math.matrix([[6,14],[8,2]]);
  prettyMatrix1="$"+math.parse(Global.String(matrix1)).toTex()+"$";
  prettyMatrix2="$"+math.parse(Global.String(matrix2)).toTex()+"$";
  resultAdd=result(function(l)
  {
   return function(r$2)
   {
  ...
  resultDivide=result(function(l)
  {
   return function(r$2)
   {
    return math.divide(l,r$2);
   };
  });
  prettyResultAdd="$"+math.parse(Global.String(resultAdd)).toTex()+"$";
  prettyResultSubtract="$"+math.parse(Global.String(resultSubtract)).toTex()+"$";
  prettyResultMultiply="$"+math.parse(Global.String(resultMultiply)).toTex()+"$";
  prettyResultDivide="$"+math.parse(Global.String(resultDivide)).toTex()+"$";
  return(b=ProviderBuilder.Make().WithHole({
   $:1,
   $0:"matrix1",
   $1:prettyMatrix1
   ...
   $:1,
   $0:"resultdivide",
   $1:prettyResultDivide
  }),(p=Handler.CompleteHoles(b.k,b.h,[]),(i=new TemplateInstance.New(p[1],MathJS_Templates.matrices(p[0])),(b.i=i,i)))).get_Doc();
 };
 Main.Units=function()
 {
  var rvInput1,rvInput2,rvTranslate,viewInput1,viewInput2,viewTranslate,resultAdd,resultSubtract,resultMultiply,resultDivide,translateResultAdd,translateResultSubtract,translateResultMultiply,translateResultDivide,b,p,i;
  function result(operator)
  {
   return View.Map2(function(l,r)
   {
    ...
    try
    {
     c=(operator(math.unit(l)))(math.unit(r));
     return Global.String(c);
    }
    catch(m)
    {
  ...
  function translate(unit,trans)
  {
   return View.Map2(function(u,t)
   {
    try
    {
     return Global.String(math.to(math.unit(u),math.unit(t)));
    }
    catch(m)
    {
  ...
  rvInput1=Var$1.Create$1("1 cm");
  rvInput2=Var$1.Create$1("1 cm");
  rvTranslate=Var$1.Create$1("m");
  viewInput1=rvInput1.get_View();
  viewInput2=rvInput2.get_View();
  viewTranslate=rvTranslate.get_View();
  resultAdd=result(function(l)
  {
   return function(r)
   {
  ...
  translateResultAdd=translate(resultAdd,viewTranslate);
  translateResultSubtract=translate(resultSubtract,viewTranslate);
  translateResultMultiply=translate(resultMultiply,viewTranslate);
  translateResultDivide=translate(resultDivide,viewTranslate);
  return(b=ProviderBuilder.Make().WithHole({
   $:8,
   $0:"input1",
   $1:rvInput1
   ...
   $:2,
   $0:"translatedresultadd",
   $1:translateResultAdd
  }).WithHole({
   $:2,
   $0:"translatedresultsubtract",
   $1:translateResultSubtract
  }).WithHole({
   $:2,
   $0:"translatedresultmultiply",
   $1:translateResultMultiply
  }).WithHole({
   $:2,
   $0:"translatedresultdivide",
   $1:translateResultDivide
  }),(p=Handler.CompleteHoles(b.k,b.h,[["input1",0],["input2",0],["translate",0]]),(i=new TemplateInstance.New(p[1],MathJS_Templates.units(p[0])),(b.i=i,i)))).get_Doc();
 };
 ...
 MathJS_Templates.bignumbers=function(h)
 {
 ...
 MathJS_Templates.differentiation=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 MathJS_Templates.vectors=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 MathJS_Templates.matrices=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 MathJS_Templates.units=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
